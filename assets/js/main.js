...
$(document).ready(function() {
  ...
  swfobject.embedSWF('http://www.rdio.com/api/swf/',
	...
	$('#play').click(function() {
		api.rdio_play($('#play_key').val());
	});
  	$('#stop').click(function() { api.rdio_stop(); });
  	$('#pause').click(function() { api.rdio_pause(); });
  	$('#previous').click(function() { api.rdio_previous(); });
  	$('#next').click(function() { api.rdio_next(); });
});
...
callback_object.ready = function ready(user) {
	api = $('#api').get(0);
	api.rdio_startFrequencyAnalyzer({
		frequencies:'10-band',
		period: 100
	});
